...
# `from evaluating_tokenizers_oov.skeleton import fib`,
...
def parse_args(args):
    ...
    parser.add_argument(
        "--version",
        action="version",
        version="evaluating_tokenizers_oov {ver}".format(ver=__version__),
    )
...
if __name__ == "__main__":
    ...
    #
    #     python -m evaluating_tokenizers_oov.skeleton 42
    #
    run()
